...
class HistWorker:
    ...
    def __init__(self):
        ...
        self.binance_client = Client("b44KeV8ChWYyeWjruDIfeRfBUFy1eIYQl3fGB8lCWR71ASE0gvdJArhLQTZDswWQ","643VQqgJP9VFmXUZguxFLNmMr0uafFKVRJyVSthm7uzYf6yZxx7MPEpfZDGGa9HO")
        return
